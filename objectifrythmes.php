...
<div class="container">
  ...
  <hr class="hrmoyen">
    ...
    <br/>
    <p class="lead text-center"> Parcours ASR2I : Administration et Sécurisation des Réseaux et services Internet et Intranet.</p>
    <ol><p class="text-center"><li>Configurer un réseau local pour un ensemble de postes informatiques, dans un environnement hétérogène
      (Windows, Linux) et assurer l’interconnexion avec le monde extérieur.</li></p>
    <p class="text-center"><li>Administrer au quotidien les serveurs rattachés au réseau informatique pour garantir, en permanence, leur
      disponibilité et leur sécurité.</li></p>
    <p class="lead text-center"> Parcours DAW2I : Développement avancé d’Applications web Internet et Intranet.</p>
...
<p class="lead"><li>A partir du mois de juin : 100% en entreprise.</li></p>
</div>
